...
#An amazing blog I found extremely helpful is here. http://syspanda.com/index.php/2017/02/07/incorporating-virustotal-data-to-elasticsearch/
#Another idea that still needs a bit of work on doing it with only powershell.  Could be the direction I want to go later. https://hazzy.techanarchy.net/winadmin/windows/windows-powershell-elk-log-wash/
...
#Use this link for a little information on Windows Event log forwarding. http://edbaker.weebly.com/blog/windows-and-logstash-quick-n-dirty
